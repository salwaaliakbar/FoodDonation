      ...
      <div className="mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-12 leading-relaxed">
            Whether you're a restaurant, business, or individual, your contribution can make 
            a real difference in someone's life. Together, we can create a hunger-free community.
          </p>
          
          {/* Grid layout for roles (donor and recipient) */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto px-2">
            ...
            <div className="bg-white/20 rounded-xl p-8">
              ...
              <p className="mb-6">
                Share your surplus food with those in need. Every donation counts in our fight against hunger.
              </p>
            </div>
            ...
            <div className="bg-white/20 rounded-xl p-8">
              ...
              <p className="mb-6">
                If you're in need of food assistance, join us today and receive the help you deserve.
              </p>
            </div>
          </div>
