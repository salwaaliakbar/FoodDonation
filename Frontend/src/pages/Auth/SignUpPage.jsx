...
function SignUpPage({ setIsLogin, setIsSignup }) {
  ...
  const { setUser } = useData(); // Set user data in context
            ...
            <Form className="bg-white shadow-2xl rounded-2xl w-full max-w-lg sm:max-w-xl lg:max-w-lg h-auto flex flex-col justify-between relative px-6 sm:px-8 py-4">
              ...
              <section className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 py-2">
                <div className="relative w-full sm:w-1/2">
                  ...
                  <Field name="fullname" placeholder="Full Name" className="block p-2 pl-10 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-green-600" />
                ...
                <div className="relative w-full sm:w-1/2">
                  ...
                  <Field name="email" placeholder="Email" className="block p-2 pl-10 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-green-600" />
              ...
              <section className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 py-2">
                <div className="relative w-full sm:w-1/2">
                  ...
                  <Field name="phone" placeholder="Phone" className="block p-2 pl-10 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-green-600" />
                ...
                <div className="relative w-full sm:w-1/2">
                  ...
                  <Field name="organization" placeholder="Organization" className="block p-2 pl-10 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-green-600" />
                  {errors.organization && touched.organization && (
                    <div className="text-red-600 text-sm">{errors.organization}</div>
                  )}
                </div>
              </section>
              ...
              <section className="relative flex flex-col sm:flex-row items-start sm:items-center py-2">
                <label className="block text-gray-700 font-bold mb-2 sm:mb-0 sm:mr-4">Role</label>
                <div className="flex space-x-4">
                  <div className="flex items-center">
                    <Field type="radio" name="role" value="donor" className="mr-2 cursor-pointer" />
                    <span>Donor</span>
                  </div>
                  <div className="flex items-center">
                    <Field type="radio" name="role" value="recipient" className="mr-2 cursor-pointer" />
                    <span>Recipient</span>
                  </div>
                </div>
              </section>
              ...
              <section className="relative py-2">
                ...
                <Field name="username" placeholder="Username" className="block p-2 pl-10 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-green-600" />
              ...
              <section>
                <button type="submit" className="bg-green-800 hover:bg-green-600 text-white font-bold py-2 my-2 px-4 rounded-md w-full transition duration-300">
                  Register
                </button>
