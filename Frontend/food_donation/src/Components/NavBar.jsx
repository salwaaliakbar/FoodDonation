  ...
  return (
    <>
      ...
      <div className="flex justify-between p-2 bg-white hover:shadow-lg transition-all duration-300 hover:text-green-600">
        <div>
          <img className="w-80 h-20 rounded-full cursor-pointer" src={logo}></img>
        </div>

        {/* ul list item */}
        <ul className="flex justify-between text-xl font-semibold text-black mt-2">
          <li className="cursor-pointer p-3 hover:border-b-3 border-green-800">About</li>
          <li className="cursor-pointer p-3 hover:border-b-3 border-green-800">Services</li>
          <li className="cursor-pointer p-3 hover:border-b-3 border-green-800">Blog</li>
          <li className="cursor-pointer p-3 hover:border-b-3 border-green-800">Contact Us</li>
        </ul>
        {/* button */}
