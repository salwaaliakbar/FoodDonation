function Navbar() {
  return (
    <>
        {/* navbaricon */}
      <div className="flex justify-between p-4 bg-white hover:shadow-lg transition-all duration-300 hover:text-green-600">
        ...
        {/* button */}
        <button className="bg-green-700 px-10 rounded text-lg font-medium hover:bg-green-600 cursor-pointer h-12 mr-4 text-white mt-2 hover:transform hover:translate-x-2 transition-all duration-300 delay-150">
          Login
        </button>
      </div>
    </>
