function Journey() {
  return (
    <div className=" text-center container mx-auto px-4 py-8 bg-gray-100 rounded-lg shadow-lg ">
      ...
      <p className="text-lg mb-6 text-gray-600 px-30">
      ...
      <div className="grid grid-cols-2 p-8 mx-25">
        <div className="text-left flex">
          <h1 className="bg-green-700 mt-2 mb-10 p-3 mr-6 rounded-4xl w-21 text-center text-white font-medium">
            2020
          </h1>
          <div>
            <h1 className="text-gray-800 text-lg font-bold">The Beginning</h1>
            <p className="text-gray-700">
              Started as a small community initiative during
              the pandemic
            </p>
          </div>
        </div>
        <div className="text-left flex ml-4">
          <h1 className="bg-green-700 mt-2 mb-10 p-3 mr-6 rounded-4xl w-23 text-center text-white font-medium">
            2021
          </h1>
          <div>
        ...
        <div className="text-left flex">
          <h1 className="bg-green-700 mt-2 mb-10 p-3 mr-6 rounded-4xl w-20 text-center text-white font-medium">
            2022
          </h1>
          <div>
