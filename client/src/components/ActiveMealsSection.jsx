...
const ActiveMealsSection = ({ Meals, title }) => {
  return (
    <section className="w-full mx-auto bg-white border border-zinc-200 rounded-xl shadow-lg mt-4 mb-4 px-2 sm:px-4">
      <h2 className="text-lg sm:text-xl font-bold text-brand-700 p-4 border-b">
        {title} Meals
      </h2>
...
const NoMeals = ({ message, hint }) => (
  <div className="flex flex-col items-center justify-center h-24 text-stone-500 text-center px-2">
